...
public class SouthIndian extends Fragment {
   ...
   String catagory = "South Indian";
    ...
    SharedPreferences preferences;    RecyclerView rv;
    ...
    private BestSellerAdapter adapter;    @SuppressLint("MissingInflatedId")
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_south_indian, container, false);
